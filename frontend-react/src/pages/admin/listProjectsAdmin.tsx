...
const ListProjectsAdmin = () => {
    ...
    useEffect(() => {
        document.title = 'Proyectos | iSkill | Admin';
            ...
            <div className='content-wrapper'>
                <div className="main-content">
                    <div className="gap-div">
                        <p className="bold-title">Todos los Proyectos</p>
                                    ...
                                    <div className="card-body">
                                        <div className="card-top">
                                            <div className="card-title-section">
                                                ...
                                                <p className="card-subtitle mb-2">{project.descripcion}</p>
                                                <p className="card-subtitle"><strong>Creado por:</strong> {project.usuario_id.nombre} {project.usuario_id.apellido}</p>
                                            </div>
                                        </div>
